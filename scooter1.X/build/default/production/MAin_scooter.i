...
# 1 "./main.h" 1
# 10 "./main.h"
# 1 "./INC/ECU/button.h" 1



# 1 "./INC/ECU/../MCAL/GPIO.h" 1
# 15 "./INC/ECU/../MCAL/GPIO.h"
# 1 "./INC/ECU/../MCAL/../device_config.h" 1
# 15 "./INC/ECU/../MCAL/GPIO.h" 2
...
# 16 "./INC/ECU/../MCAL/GPIO.h" 2

# 1 "./INC/ECU/../MCAL/../std_types.h" 1
# 12 "./INC/ECU/../MCAL/../std_types.h"
# 1 "./INC/ECU/../MCAL/../compiler.h" 1
# 12 "./INC/ECU/../MCAL/../std_types.h" 2
...
# 17 "./INC/ECU/../MCAL/GPIO.h" 2
# 31 "./INC/ECU/../MCAL/GPIO.h"
typedef enum {
   LOW =0,
   HIGH
}logic_t;
...
# 1 "./INC/ECU/HAL_LED.h" 1
# 19 "./INC/ECU/HAL_LED.h"
typedef struct {
    uint8 port_name :4;
       uint8 pin :3;
         uint8 led_status :1;
...
# 1 "./src/ECU/seven_seg.h" 1
# 13 "./src/ECU/seven_seg.h"
typedef enum
{ COMMON_CATHODE,
        COMMON_ANODE
...
.pwm_frequncy=50,
.timer2_postscaler_value=16,
.timer2_prescaler_value=16};
...

{
  ...
  if(LIGHTS_btn_OFF_activ==BUTTON_ACTIVE_HIGH)
     ...
     CCP_PWM_Set_Duty(&motor_sp,data*25);
